export const experienceData = [
  {
    ...
    description: 'Leading the development of AI-powered analytics platform serving enterprise clients across finance, healthcare, and retail sectors.',
    achievements: [
    ...
    companyDescription: 'TechVision Inc. is a leading AI and analytics company providing enterprise solutions to Fortune 500 companies. With over 500 employees globally, the company specializes in predictive analytics, business intelligence, and machine learning applications.',
  ...
  },
  {
    ...
    description: 'Managed the complete product lifecycle for a SaaS marketing automation platform serving mid-market B2B clients.',
    achievements: [
    ...
    companyDescription: 'InnovateSoft is a B2B SaaS company specializing in marketing automation and customer engagement tools. The company serves over 2,000 clients globally and has been recognized as a leader in the Gartner Magic Quadrant for Marketing Automation.',
    logo: 'https://images.unsplash.com/photo-1560179707-f14e90ef3623?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1074&q=80',
  },
  {
    ...
    description: 'Supported the development of mobile payment solutions for emerging markets, focusing on user experience and feature prioritization.',
    achievements: [
    ...
    companyDescription: 'GlobalTech Solutions is a fintech company focused on developing payment solutions for emerging markets. The company operates in over 15 countries and has processed more than $5 billion in transactions since its founding in 2010.',
    logo: 'https://images.unsplash.com/photo-1560179707-f14e90ef3623?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1074&q=80',
  },
  {
    ...
    description: 'Analyzed market trends and user feedback to inform product decisions for an early-stage health tech startup.',
    achievements: [
    ...
    companyDescription: 'StartupLaunch was a health tech startup focused on developing mobile applications for personal health monitoring and wellness tracking. The company was acquired by a major health insurance provider in 2018.',
    logo: 'https://images.unsplash.com/photo-1560179707-f14e90ef3623?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1074&q=80',
  },
];