export default function NotFound() {
  return (
    <section className="bg-nord-6 dark:bg-nord-0 py-20">
      <div className="mx-auto flex min-h-[60vh] w-full max-w-6xl flex-col items-center justify-center px-4 text-center">
        <div className="space-y-8">
          <p className="text-nord-9 dark:text-nord-6 text-8xl font-black md:text-9xl">404</p>
          <div className="space-y-6">
            ...
            <p className="text-nord-3 dark:text-nord-4 max-w-xl text-base">
