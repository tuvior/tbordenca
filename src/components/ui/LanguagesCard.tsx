...
const LanguagesCard: React.FC<LanguagesCardProps> = ({ languages }) => {
  return (
    ...
    >
      <div className="border-nord-4 bg-nord-6 dark:border-nord-3 dark:bg-nord-1 rounded-xl border p-4 shadow-md">
          ...
          {languages.map((language, index) => (
            <div key={index}>
              <div className="mb-1 flex justify-between">
                ...
                <span className="text-nord-3 dark:text-nord-4 text-xs">{language.level}</span>
              </div>
              <div className="bg-nord-4 dark:bg-nord-3 h-2 w-full overflow-hidden rounded-full">
                <div
